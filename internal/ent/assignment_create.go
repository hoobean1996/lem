...
func (_c *AssignmentCreate) SetTitle(v string) *AssignmentCreate {
	_c.mutation.SetTitle(v)
	return _c
}

// SetDescription sets the "description" field.
func (_c *AssignmentCreate) SetDescription(v string) *AssignmentCreate {
	_c.mutation.SetDescription(v)
	return _c
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (_c *AssignmentCreate) SetNillableDescription(v *string) *AssignmentCreate {
	if v != nil {
		_c.SetDescription(*v)
	}
	return _c
...
func (_c *AssignmentCreate) SetLevelIds(v []string) *AssignmentCreate {
	_c.mutation.SetLevelIds(v)
	return _c
}

// SetMaxPoints sets the "max_points" field.
func (_c *AssignmentCreate) SetMaxPoints(v int) *AssignmentCreate {
	_c.mutation.SetMaxPoints(v)
	return _c
}

// SetNillableMaxPoints sets the "max_points" field if the given value is not nil.
func (_c *AssignmentCreate) SetNillableMaxPoints(v *int) *AssignmentCreate {
	if v != nil {
		_c.SetMaxPoints(*v)
	}
	return _c
...
func (_c *AssignmentCreate) SetDueDate(v time.Time) *AssignmentCreate {
	_c.mutation.SetDueDate(v)
	return _c
}

// SetNillableDueDate sets the "due_date" field if the given value is not nil.
func (_c *AssignmentCreate) SetNillableDueDate(v *time.Time) *AssignmentCreate {
	if v != nil {
		_c.SetDueDate(*v)
	}
	return _c
...
func (_c *AssignmentCreate) SetStatus(v assignment.Status) *AssignmentCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *AssignmentCreate) SetNillableStatus(v *assignment.Status) *AssignmentCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *AssignmentCreate) defaults() {
	if _, ok := _c.mutation.MaxPoints(); !ok {
		v := assignment.DefaultMaxPoints
		_c.mutation.SetMaxPoints(v)
	}
	if _, ok := _c.mutation.Status(); !ok {
		v := assignment.DefaultStatus
		_c.mutation.SetStatus(v)
	}
...
func (_c *AssignmentCreate) check() error {
	...
	if _, ok := _c.mutation.MaxPoints(); !ok {
		return &ValidationError{Name: "max_points", err: errors.New(`ent: missing required field "Assignment.max_points"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
	...
	if len(_c.mutation.ClassroomIDs()) == 0 {
		return &ValidationError{Name: "classroom", err: errors.New(`ent: missing required edge "Assignment.classroom"`)}
	}
	return nil
}
...
func (_c *AssignmentCreate) createSpec() (*Assignment, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.ClassroomIDs(); len(nodes) > 0 {
		...
		_node.classroom_assignments = &nodes[0]
